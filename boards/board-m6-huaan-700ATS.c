...
#include "board-m6-huaan-700ATS.h"
...
{
    gpio_out(PAD_GPIOE_10, 1);    // set front camera power disable
...
#endif
#ifdef CONFIG_GSL1680_CAPACITIVE_TOUCHSCREEN_HUAAN_700ATS 
    {
...
static int dvb_io_setup(void *p)
{
	...
	printk(KERN_ERR "dvb_io_setup start\n");
	{
		static pinmux_item_t fec_pins[] = {
		    ...
		    #if 1
		    {
		        .reg = PINMUX_REG(3),  //skyworth serial is ok
		        .setmask = 0x3f
		    },
		    {
		        .reg = PINMUX_REG(0),
...
static struct resource amlogic_dvb_fe_resource[]  = {
	...
	[0] = {
		.start = 6,                                 //DTV demod: M1=0, SI2176=1, MXL101=2,, AVL6211=3,MN88436=4
		.end   = 6,
	...
	[1] = {
		.start = 3, 								//i2c adapter id
		.end   = 3,
		.flags = IORESOURCE_MEM,
		.name  = "dtv_demod0_i2c_adap_id"
	},
	[2] = {
		.start = 0x18,								//i2c address
		.end   = 0x18,
		.flags = IORESOURCE_MEM,
	...
	[8] = {
		.start = PAD_GPIOD_6,//(GPIOB_bank_bit0_23(19)<<16)|GPIOB_bit_bit0_23(19),  //// tuner_enable
		.end   =PAD_GPIOD_6, //(GPIOB_bank_bit0_23(19)<<16)|GPIOB_bit_bit0_23(19),
		.flags = IORESOURCE_MEM,
...
static struct resource mn88436_resource[]  = {
	[0] = {
		.start = PAD_GPIOC_4,//(GPIOD_bank_bit0_9(8)<<16)|GPIOD_bit_bit0_9(8), //reset pin
		.end   = PAD_GPIOC_4,//(GPIOD_bank_bit0_9(8)<<16)|GPIOD_bit_bit0_9(8),
		.flags = IORESOURCE_MEM,
	...
	[2] = {
		.start = 0x60,//NULL,                                 //frontend 0 tuner address  nmi120 tuner
		.end   = 0x60,//NULL,
		.flags = IORESOURCE_MEM,
		.name  = "frontend0_tuner_addr"
	},
	[3] = {
		.start = 0x18,//0xce,                                 //frontend 0 demod address
		.end   = 0x18,//0xce,
		.flags = IORESOURCE_MEM,
		.name  = "frontend0_demod_addr"
	},
	[4] = {
		.start = PAD_GPIOD_6,//PAD_GPIOC_2,  //// tuner_enable
		.end   = PAD_GPIOD_6,//PAD_GPIOC_2,
		.flags = IORESOURCE_MEM,
...
MACHINE_START(MESON6_HUAAN_700ATS, "Amlogic Meson6 huaan 700ATS board")
